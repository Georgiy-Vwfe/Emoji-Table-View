...
class EmojiTableViewController: UITableViewController {
    var emojis: [Emoji] = [
        Emoji(symbol: "🐢", name: "Черепаха", description: "Зеленая черепаха", usage: "Очень медленно"),
        ...
        Emoji(symbol: "🐱", name: "Кошка", description: "Желтая морда кота", usage: "Гуляю сам по себе"),
        ...
        Emoji(symbol: "🦊", name: "Лиса", description: "Рыжая лиса", usage: "Врожденная хитрость"),
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "EditEmoji" {
            ...
            let viewController = navigationController.topViewController as! AddEditEmojiTableViewController
